...
export default function DashboardPage() {
  ...
  const handleCancel = async (slotId: string, txHash: string) => {
    ...
    try {
      ...
      const numericSlotId = parseInt(slotId.slice(-8), 16);
                    ...
                    <TableCell className="px-8 py-8 text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        {isPast(booking.startTime) && (
                          <>
                            <Link href={`/prescription/${booking._id}`}>
                              <Button
                                variant="outline"
                                size="sm"
                                className="font-bold border-2 border-indigo-600 text-indigo-600 rounded-xl hover:bg-indigo-50 transition-all h-12 px-4"
                              >
                                View Rx
                              </Button>
                            </Link>
                            <Button
                              variant="outline"
                              size="sm"
                              className="font-bold border-2 border-amber-400 text-amber-600 rounded-xl hover:bg-amber-50 transition-all h-12"
